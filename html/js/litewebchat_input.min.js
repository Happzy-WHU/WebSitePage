...
function insertAtCursor(e, t) { 
  ...
  if (n.focus(), window.getSelection) { 
    ...
    if (i.getRangeAt && i.rangeCount) { 
      ...
      c.innerHTML = o; 
      for (var d = document.createDocumentFragment(); l = c.firstChild;) 
        a = d.appendChild(l); 
      r.insertNode(d); 
      a && ((r = r.cloneRange()).setStartAfter(a), r.collapse(!0), i.removeAllRanges(), i.addRange(r)) 
    } 
...
function inputFile(e) { 
  ...
  if (e.enable) { 
    imageBtn.onclick = function () { 
      ...
      e.onchange = function () { 
        for (var e = chatInput.getElementsByTagName("img").length, i = 0; i < this.files.length; i++) 
          (-1 == n || e < n) && (-1 == t || this.files[i].size <= t ? (e++, addImage(this.files[i])) : o(this.files[i])) 
      }; 
      e.click() 
    }; 
    ...
    e.enableDrop && (downChild.ondrop = function (e) { 
      ...
      for (var i = chatInput.getElementsByTagName("img").length, l = 0; l < e.dataTransfer.files.length; l++) { 
        ...
        (-1 == n || i < n) && (-1 == t || a.size <= t ? (addImage(a), i++) : o(a)) : 
        o(a) 
      } 
    }, 
...
emojiBtn.onclick = function () { 
  ...
  e < (upperHeight = upperChild.clientHeight) ? 
  (emojiMart.style.bottom = "".concat(downHeight + 3, "px"), emojiMart.style.top = "") : 
...
exitFullScreen.onclick = function () { 
  0 != upperHeight ? 
  (downChild.style.height = "".concat(downHeight, "px"), upperChild.style.height = "calc(100% - ".concat(downHeight, "px)")) : 
  (upperChild.style.height = "calc(100% - 150px)", downChild.style.height = "150px"), 
